...
parser.add_argument("-sd", "--seed", help="Stable Diffusion Seed (-1 = Random)", default="754943641")
parser.add_argument("-sn", "--sampler-name", help="Sampler Name", default="DPM++ 2M")
parser.add_argument("-rnm", "--random-noise-method", help="GPU or CPU", default="GPU")
